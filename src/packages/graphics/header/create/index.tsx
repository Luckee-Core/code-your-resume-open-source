    ...
    <div className={styles.modalBackdrop} role="presentation" onClick={() => dispatch(StudioBuilderActions.closeCreateGraphicModal())}>
      ...
      >
        ...
        <div className={styles.presetsSection}>
          <p className={styles.sectionTitle}>Presets: social, résumé, web</p>
          <p className={styles.presetsIntro}>
            Social and link-preview sizes, plus US Letter and A4 page dimensions at 96dpi for
            one-page layouts—tap to apply. Orientation is noted per preset.
          </p>
