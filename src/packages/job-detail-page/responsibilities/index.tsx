...
export const ResponsibilitiesSection = () => {
  const jobId = useAppSelector((s) => s.currentJob.id);
  const allRows = useAppSelector((s) => s.jobResponsibilities);
  ...
  console.log("[ResponsibilitiesSection]", {
    jobId,
  ...
  return (
    <section className={styles.card} aria-labelledby="crm-job-responsibilities-heading">
      <h2 id="crm-job-responsibilities-heading" className={styles.cardTitle}>
        Responsibilities
      </h2>
      {items.length === 0 ? (
