...
import { SendOffSitesPanel } from "./send-off-sites-panel";
import { StudioThumbnailDownloadPanel } from "./studio-thumbnail-download-panel";
  ...
  return (
    <div className={styles.root}>
      <section className={styles.panel}>
        ...
        <StudioThumbnailDownloadPanel previewHasContent={previewHasContent} />
        <SendOffSitesPanel />
      </section>
    </div>
  );
