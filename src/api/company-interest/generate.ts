 ...
 *
 * Queues company-interest generation on Express; graphic is persisted server-side.
 *
 * @param input - Job id
...
export const generateCompanyInterest = async (
  ...
  const result = await requestApi<GenerateAcceptedResponse>("/api/data/company-interest/generate", {
    method: "POST",
