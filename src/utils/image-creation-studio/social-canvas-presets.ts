/**
 * Common social / ad canvas sizes plus document page presets (approximate platform
 * recommendations). Users pick one at graphic creation; dimensions are stored on the graphic.
 */
