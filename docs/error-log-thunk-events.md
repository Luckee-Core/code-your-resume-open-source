# Thunk error events (audit)

Stable `event` strings sent to `thunk_errors`. One per thunk file.

| Event | Thunk file |
|-------|------------|
| `failedToGenerateCoverLetter` | `src/store/thunks/cover-letter/generateCoverLetterThunk.ts` |
