...
- `src/app/api/**/route.ts`: Next.js route handlers for **non-CRM** HTTP only. **CRM** entity traffic goes to the Express server at `/api/data/**` (see [008 – Job-search CRM](./008-job-search-crm.md)).
