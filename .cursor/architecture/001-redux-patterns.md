...
## Context
This ADR defines mandatory Redux patterns for **code-your-resume-open-source** so async flows, slice state, and reducer behavior remain predictable across features.
